...
<body class="antialiased">
    ...
    <p>Our privacy policy will help you understand what information we collect at <em>[সিডিএসপি কৃষি cdsp krishi
            bd.org.cdsp.cdsp_krishi]</em>, how <em>[সিডিএসপি কৃষি cdsp krishi bd.org.cdsp.cdsp_krishi]</em> uses it, and
        what choices you have.
        <em>[সিডিএসপি কৃষি cdsp krishi bd.org.cdsp.cdsp_krishi]</em> built the <em>[সিডিএসপি কৃষি cdsp krishi
            bd.org.cdsp.cdsp_krishi]</em> app as a free app. This SERVICE is provided by <em>[সিডিএসপি কৃষি cdsp krishi
            bd.org.cdsp.cdsp_krishi]</em> at no cost and is intended for use as is.
        ...
        use
        or share your information with anyone except as described in this Privacy Policy.<br>The terms used in this
        Privacy
        Policy have the same meanings as in our Terms and Conditions, which is accessible in our website, unless
        otherwise
    ...
    <p>For a better experience while using our Service, we may require you to provide us with certain personally
        ...
        The
        information that we request will be retained by us and used as described in this privacy policy.<br>The app does
        use
        third party services that may collect information used to identify you. </p>
    <h3 id="cookies">Cookies</h3>
    <p>Cookies are files with small amount of data that is commonly used an anonymous unique identifier. These are sent
        to
        your browser from the website that you visit and are stored on your devices’s internal memory. </p>
    <p>This Services does not uses these “cookies” explicitly. However, the app may use third party code and libraries
        that
    ...
    <p>Some of the services may use location information transmitted from users&#39; mobile phones. We only use this
        information within the scope necessary for the designated service. </p>
    ...
    <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us.<br>Contact
        Information:<br>Email: <em>[apps.cdsp@gmail.com]</em></p>
